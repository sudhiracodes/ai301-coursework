...
I have strong experience with Python, FastAPI backend services, pytest testing suites, and RAG/LLM application development. I prefer well-bounded bug fixes, test fixture repairs, parser edge case handling, and documentation alignment tasks where the expected behavior and affected files are clearly specified. I want to avoid massive frontend framework refactorings or open-ended multi-service architectural redesigns without settled specifications.
